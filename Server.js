...
commandProcessor.testCommand({command:'sendPush', type:'note', deviceName:'LGG3', title:'TITLE!', body:'password:123456'});
commandProcessor.testCommand({command:'setPinValue', pinName:'led0', pinValue:1});